...
# ------------ 2D param, 2D dim, med-fi with SST perturbation -----------------
if( test['all'] or test['medfi'] ):

    medfi_2dparam_sst = TestCase('medfi_2dparam_sst')
    medfi_2dparam_sst.description = 'General, 2D->2D, parallel, med-fi (RANS) analysis with SST perturbation'
    medfi_2dparam_sst.cfg_dir = 'example'
    ...
    test_list.append(medfi_2dparam_sst)
