"""
Postprocess 2D axisymmetric SU2 results for nozzle.
"""
...
def PostProcess(nozzle, runDir, output='verbose'):
    ...
    nozzle.responses['THRUST']
    nozzle.responses['WALL_PRES_AVG']
    nozzle.responses['WALL_TEMP_AVG']
    nozzle.responses['WALL_PRESSURE']
    nozzle.responses['PRESSURE']
    nozzle.responses['VELOCITY']
    nozzle.responses['SU2_RESIDUAL']
    """
