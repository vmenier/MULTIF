...
int call(gmfgetvertex3ddoublef77)(int *, double *, double *, double *, int *);
int call(gmfsetvertex2df77)(int *, float *, float *, int *);
int call(gmfsetvertex3df77)(int *, float *, float *, float *, int *);
int call(gmfsetvertex3ddoublef77)(int *, double *, double *, double *, int *);
...
int call(gmfsetsolf77)(int *, int *, float *);
int call(gmfsetsoldoublef77)(int *, int *, double *);
int call(gmfgetsolf77)(int *, int *, float *);
int call(gmfgetsoldoublef77)(int *, int *, double *);
