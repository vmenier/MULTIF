...
\begin{table}
\caption[Dimensions of model inputs]{Total dimension of model inputs for various parameterizations. The standard and high-dimension parameterization are the most feasible for real design problems.}
...
\subsection{Deterministic Low-Fidelity Optimization}

This optimization problem corresponds to the equivalent deterministic optimization problem for the specific reliable DUU problem found in equation \ref{eq:specific_reliable_equiv_deterministic_optim} using the standard parameterization from table \ref{tab:inputDimension}. 
...
\begin{center}
\begin{tabular}[]{ c | c | c }
\textbf{Description} & \textbf{Notation} & \textbf{Value} \\ \hline
Mass & $M$ & 32.843833 \\ \hline
Thrust & $F$ & 21500.000632 \\ \hline
Inner load layer P-norm of temperature ratio & $g_1(\sfrac{T_2}{T_{max,2}})$ & 0.437059 \\ \hline
Thermal layer P-norm of failure criterion & $g_2(S_1(\sigma_1))$ & 0.122024 \\ \hline
Inner load layer P-norm of failure criterion & $g_3(S_2(\sigma_2))$ & 0.050842 \\ \hline
Middle load layer P-norm of failure criterion & $g_4(S_3(\sigma_3))$ & 0.212316 \\ \hline
Outer load layer P-norm of failure criterion & $g_5(S_4(\sigma_4))$ & 0.035907 \\ \hline
Stringers P-norm of failure criterion & $g_6(S_5(\sigma_5))$ & 0.024764 \\ \hline
Baffle 1 P-norm of failure criterion & $g_7(S_6(\sigma_6))$ & 0.002868 \\ \hline
Baffle 2 P-norm of failure criterion & $g_8(S_7(\sigma_7))$ & 0.007546 \\ \hline
Baffle 3 P-norm of failure criterion & $g_9(S_8(\sigma_8))$ & 0.006873 \\ \hline
Baffle 4 P-norm of failure criterion & $g_{10}(S_9(\sigma_9))$ & 0.004623 \\ \hline
Baffle 5 P-norm of failure criterion & $g_{11}(S_{10}(\sigma_{10}))$ & 0.002679 \\ \hline
Baffle 6 P-norm of failure criterion & $g_{12}(S_{11}(\sigma_{11}))$ & 0.002224 \\ \hline
\end{tabular}
\end{center}
\end{table}
